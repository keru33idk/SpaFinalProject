...
public class CategoriaService {
    ...
    public void insertarCategoria(UUID id, String nombre) throws SQLException {
    ...
    public void actualizarCategoria(UUID id, String nuevoNombre) throws SQLException {
    ...
    public void eliminarCategoria(UUID id) throws SQLException {
